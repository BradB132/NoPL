...
#define NoPL_BYTE_ARG_NUMBER 58
#define NoPL_BYTE_ARG_STRING 59
#define NoPL_BYTE_ARG_BOOLEAN 60
#define NoPL_BYTE_ARG_OBJECT 61

//DEBUGGING
#define NoPL_BYTE_DEBUG_LINE 62
